 ...
 * * `newrig()->is_primary_sidebar_active()`
 * * `newrig()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			[
				'name'          => esc_html__( 'Sidebar', 'newrig' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'newrig' ),
		...
		register_sidebar(
			[
				'name'          => esc_html__( 'Footer widgets', 'newrig' ),
